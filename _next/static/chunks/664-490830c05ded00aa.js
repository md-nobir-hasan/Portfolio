  ...
  [664],
  {
    ...
    8418: function (e, t, o) {
      ...
      var b = u.default.forwardRef(function (e, t) {
        ...
        I && (T = I);
        var S = u.default.useMemo(
            function () {
              var e = n(l.resolveHref(T, b, !0), 2),
                t = e[0],
                o = e[1];
              return { href: t, as: h ? l.resolveHref(T, h) : o || t };
            },
            [T, b, h]
          ),
          U = S.href,
        ...
        var z = {
          ...
          onMouseEnter: function (e) {
            k || "function" != typeof R || R(e),
              ...
              !(!w && I) && l.isLocalURL(U) && y(T, U, B, { priority: !0 });
          },
        ...
        if (!k || g || ("a" === r.type && !("href" in r.props))) {
          var F = void 0 !== L ? L : T && T.locale,
            J =
              T &&
              T.isLocaleDomain &&
              d.getDomainLocale(B, F, T.locales, T.domainLocales);
          z.href = J || p.addBasePath(f.addLocale(B, F, T && T.defaultLocale));
        }
        return k
          ? u.default.cloneElement(r, z)
          : u.default.createElement("a", Object.assign({}, P, z), o);
      });
      (t.default = b),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
